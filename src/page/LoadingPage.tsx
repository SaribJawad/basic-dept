...
function LoadingPage() {
  return (
    <motion.section
      className="h-dvh w-full fixed z-20 top-0 bottom-0 flex items-center justify-center   bg-[#F2F2F2]"
      initial={{ y: 0 }}
      animate={{ y: "-100%" }}
    ...
    >
      <div className="overflow-hidden">
        <motion.svg
          ...
          className="md:w-[450px] sm:w-[300px] xs:w-[250px] w-[200px]   duration-100 z-10"
          initial={{ y: 0 }}
          animate={{ y: "-100%" }}
